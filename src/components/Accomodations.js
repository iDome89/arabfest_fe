...
export const Accomodations = () => {
  ...
  useEffect(() => {
    const fetchAccomodations = async () => {
      try {
        const response = await apiRequest.get("/accomodations?sort=id&populate=*", {
          headers: {
            ...
            >
              ...
              <div className="grid h-full items-start grid-cols-4 bg-gray-100 p-4">
                ...
                <div className="flex items-center col-span-4 mt-2 gap-[5px]">
                  ...
                  <a href={venue.attributes.map_link} className="text-xs text-gray-700 hover:text-black">
                ...
                <div className="flex items-center col-span-4 mt-2 gap-[5px]">
                  ...
                  <a href={venue.attributes.website} className="text-xs text-gray-700 hover:text-black">
                    {venue.attributes.name}
                  </a>
                </div>
                <div className="flex items-center col-span-4 mt-2 gap-[5px]">
                  ...
                  <div className="text-xs text-gray-700 hover:text-black">
                    {parse(venue.attributes.info)}
                  </div>
                </div>
              </div>
            </div>
